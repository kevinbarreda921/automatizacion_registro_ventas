...
# 1. Cargamos el archivo (sin usar la primera fila como nombres)
df = pd.read_excel('Main/Grifos/brasil/leercreditos/PARTE DIARIO 3 ENERO BRASIL.xlsx', sheet_name='21.01.26',header=None)

# 2. Generamos las letras de Excel (A, B, C...) según el número de columnas
...
# 3. ¡Ahora busca como en Excel!
# Ejemplo: Fila 10, Columna B
valor = df.loc[10, 'B']

print(f"El valor en la celda B10 es: {valor}")
